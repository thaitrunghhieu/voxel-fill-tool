...
function showLayer(which){
  ...
  for(let i=0;i<voxelPositions.length;i++){
    ...
    dummy.position.copy(voxelPositions[i]);dummy.quaternion.identity();dummy.scale.setScalar(depthVisible?1:0);dummy.updateMatrix();voxelMesh.setMatrixAt(i,dummy.matrix);
  }
